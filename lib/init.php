...
if ( ! function_exists( '_bctheme_setup' ) ) :
/**
 ...
 */
function _bctheme_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on _bctheme, use a find and replace
	 * to change '_bctheme' to the name of your theme in all the template files
	 */
	load_theme_textdomain( '_bctheme', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', '_bctheme' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( '_bctheme_custom_background_args', array(
...
add_action( 'after_setup_theme', '_bctheme_setup' );
