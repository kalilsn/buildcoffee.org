...
function bc_scripts() {
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'customplugins', get_template_directory_uri() . '/assets/js/plugins.min.js', [ 'jquery' ], null, true );
		wp_enqueue_script( 'customscripts', get_template_directory_uri() . '/assets/js/main.min.js', [ 'jquery' ], null, true );
	}
}
